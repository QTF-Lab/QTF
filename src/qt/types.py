...
# It's a dictionary mapping a symbol (str) to its target weight (float).
# Example: {"AAPL": 0.5, "GOOG": 0.5} for an equally-weighted portfolio.
# Example: {"SPY": 1.0} for a fully long position.
# Example: {"QQQ": 0.0} to signal being flat or exiting a position.
